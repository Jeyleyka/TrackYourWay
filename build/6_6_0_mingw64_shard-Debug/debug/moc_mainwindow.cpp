...
QT_MOC_LITERAL(1, 15, 13), // "deleteClicked"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 15), // "TaskItemWidget*"
QT_MOC_LITERAL(4, 46, 4), // "item"
QT_MOC_LITERAL(5, 51, 15) // "onDeleteClicked"

    },
    "TaskItemWidget\0deleteClicked\0\0"
    "TaskItemWidget*\0item\0onDeleteClicked"
};
...
void TaskItemWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->deleteClicked((*reinterpret_cast< TaskItemWidget*(*)>(_a[1]))); break;
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< TaskItemWidget* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (TaskItemWidget::*)(TaskItemWidget * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskItemWidget::deleteClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TaskItemWidget::deleteClicked(TaskItemWidget * _t1)
{
...
QT_MOC_LITERAL(4, 43, 4) // "item"
    ...
    "MainWindow\0onItemClicked\0\0QListWidgetItem*\0"
    "item"
};
#undef QT_MOC_LITERAL
