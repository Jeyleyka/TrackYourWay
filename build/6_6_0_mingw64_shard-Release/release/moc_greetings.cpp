...
QT_MOC_LITERAL(1, 10, 16), // "openSecondWindow"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 11) // "handleLogin"

    },
    "Greetings\0openSecondWindow\0\0handleLogin"
};
...
void Greetings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Greetings *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Greetings::staticMetaObject = { {
    ...
    qt_meta_stringdata_Greetings.data,
    qt_meta_data_Greetings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
